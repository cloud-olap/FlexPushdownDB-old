...
class CalciteServerIf {
 public:
  ...
  virtual void sql2Plan(TPlanResult& _return, const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering) = 0;
...
class CalciteServerNull : virtual public CalciteServerIf {
 public:
  ...
  void sql2Plan(TPlanResult& /* _return */, const std::string& /* query */, const std::string& /* schemaName */, const bool /* useHeuristicJoinOrdering */) override {
    return;
  }
...
typedef struct _CalciteServer_sql2Plan_args__isset {
  _CalciteServer_sql2Plan_args__isset() : query(false), schemaName(false), useHeuristicJoinOrdering(false) {}
  bool query :1;
  bool schemaName :1;
  bool useHeuristicJoinOrdering :1;
...
class CalciteServer_sql2Plan_args {
 public:
  ...
  void __set_useHeuristicJoinOrdering(const bool val);
  ...
  bool operator == (const CalciteServer_sql2Plan_args & rhs) const
  {
    ...
    if (!(schemaName == rhs.schemaName))
      return false;
    if (!(useHeuristicJoinOrdering == rhs.useHeuristicJoinOrdering))
      return false;
    return true;
  }
  bool operator != (const CalciteServer_sql2Plan_args &rhs) const {
...
class CalciteServer_sql2Plan_pargs {
 public:
  ...
  const bool* useHeuristicJoinOrdering;
...
class CalciteServerClient : virtual public CalciteServerIf {
 ...
 public:
  ...
  void recv_shutdown();
  void sql2Plan(TPlanResult& _return, const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering) override;
  void send_sql2Plan(const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering);
...
class CalciteServerMultiface : virtual public CalciteServerIf {
 ...
 public:
  ...
  void sql2Plan(TPlanResult& _return, const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->sql2Plan(_return, query, schemaName, useHeuristicJoinOrdering);
    }
    ifaces_[i]->sql2Plan(_return, query, schemaName, useHeuristicJoinOrdering);
    return;
  }
  ...
  CalciteServerConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void sql2Plan(TPlanResult& _return, const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering) override;
  int32_t send_sql2Plan(const std::string& query, const std::string& schemaName, const bool useHeuristicJoinOrdering);
